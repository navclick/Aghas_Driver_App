...
//
    ...
    @Expose
    private List<OrderList.Value> value;
    ...
    public List<OrderList.Value> getValue() {
        return value;
    }

    public void setValue(List<OrderList.Value> value) {
        this.value = value;
    }
    ...
    public class Value {
        ...
        @Expose
        private List<Order.OrderItem> orderItem = null;
